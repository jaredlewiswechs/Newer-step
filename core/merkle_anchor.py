...
class MerkleAnchorScheduler:
    ...
    def __init__(
        self, ledger, interval_seconds: int = 300, storage_path: str = ".newton_anchors"
    ):
        """
    ...
    def stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "latest_anchor": (
                self.get_latest_anchor().to_dict() if self.get_latest_anchor() else None
            ),
        }


def verify_merkle_proof(
    entry_hash: str, proof_path: List[Dict[str, str]], merkle_root: str
) -> bool:
    """
