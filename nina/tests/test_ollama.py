...
class TestOllamaConfig(unittest.TestCase):
    ...
    def test_custom_config(self):
        ...
        config = OllamaConfig(model="llama3", temperature=0.7, max_tokens=1024)
...
class TestPipelineOllamaFallback(unittest.TestCase):
    ...
    def test_kb_query_returns_trusted(self):
        ...
        self.assertIn(
            result.trust_label,
            [TrustLabel.TRUSTED, TrustLabel.VERIFIED, TrustLabel.UNTRUSTED],
        )
...
class TestOllamaGovernance(unittest.TestCase):
    ...
    def test_ollama_source_gets_verified_label(self):
        ...
        ollama_labeled = lattice.label(
            "Step 1: ...", TrustLabel.VERIFIED, "ollama_governed"
        )
