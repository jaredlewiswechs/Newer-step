...
class TestBezierCurve:
    ...
    def test_curve_type_linear(self):
        ...
        curve = BezierCurve(
            start=Point(0, 0), end=Point(100, 100), control1=None, control2=None
        )
...
class TestCurveFactory:
    ...
    def test_create_with_relationship(self):
        ...
        curve = CurveFactory.create(
            start=Point(0, 0), end=Point(100, 100), relationship="references"
        )
...
class TestCurveStore:
    ...
    def test_add_and_get(self, curve_store):
        ...
        curve = CurveFactory.create(
            start=Point(0, 0), end=Point(100, 100), source_hash="src", target_hash="tgt"
        )
    ...
    def test_get_from_source(self, curve_store):
        ...
        curve1 = CurveFactory.create(
            start=Point(0, 0), end=Point(50, 50), source_hash="A", target_hash="B"
        )
        curve2 = CurveFactory.create(
            start=Point(0, 0), end=Point(100, 100), source_hash="A", target_hash="C"
        )
        curve3 = CurveFactory.create(
            start=Point(50, 50), end=Point(100, 100), source_hash="B", target_hash="C"
        )
    ...
    def test_export(self, curve_store):
        """Export all curves."""
        curve = CurveFactory.create(start=Point(0, 0), end=Point(100, 100))
...
class TestSVGRenderer:
    ...
    def test_render_single_curve(self):
        ...
        curve = CurveFactory.create(start=Point(10, 10), end=Point(90, 90))
    ...
    def test_render_styled_curve(self):
        ...
        curve = CurveFactory.create(
            start=Point(10, 10), end=Point(90, 90), relationship="cites"  # dotted style
        )
...
class TestBezierProperties:
    ...
    def test_curve_has_valid_svg(self, x1, y1, x2, y2):
        ...
        curve = CurveFactory.create(start=Point(x1, y1), end=Point(x2, y2))
