...
class TestRegimeValidation:
    ...
    def test_validate_with_rules(self):
        ...
        regime = Regime(
            regime_type=RegimeType.CUSTOM,
            domain_rules=[non_empty_rule(), numeric_rule(), positive_rule()],
        )
...
class TestTrustedSources:
    ...
    def test_is_source_trusted(self):
        ...
        regime = Regime(
            regime_type=RegimeType.CUSTOM, trusted_sources={"database", "api"}
        )
...
class TestRegimeRegistry:
    ...
    def test_register_and_get(self):
        ...
        custom = Regime(regime_type=RegimeType.CUSTOM, name="test_regime")
