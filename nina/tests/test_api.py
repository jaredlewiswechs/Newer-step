...
class TestCardAPI:
    ...
    def test_get_card(self, client):
        ...
        create_resp = client.post(
            "/nina/cards", json={"title": "Retrievable", "content": "Find me"}
        )
    ...
    def test_get_card_by_hash(self, client):
        ...
        # Create first
        create_resp = client.post(
            "/nina/cards", json={"title": "By Hash", "content": "Find me"}
        )
    ...
    def test_update_card(self, client):
        ...
        # Create
        create_resp = client.post(
            "/nina/cards", json={"title": "Original", "content": "Original content"}
        )
        card_id = create_resp.json()["data"]["id"]

        # Update
        response = client.put(
            f"/nina/cards/{card_id}",
    ...
    def test_delete_card(self, client):
        ...
        # Create
        create_resp = client.post(
            "/nina/cards", json={"title": "To Delete", "content": "Gone soon"}
        )
        card_id = create_resp.json()["data"]["id"]
    ...
    def test_list_cards_with_filter(self, client):
        ...
        client.post(
            "/nina/cards",
            json={"title": "Tagged", "content": "Has the tag", "tags": ["special"]},
        )
        client.post(
            "/nina/cards", json={"title": "Not Tagged", "content": "No special tag"}
        )
...
class TestServiceAPI:
    ...
    def test_run_echo_service(self, client):
        ...
        # Create card
        create_resp = client.post(
            "/nina/cards", json={"title": "Echo Me", "content": "Echo this content"}
        )
        card_hash = create_resp.json()["data"]["hash"]
        ...
        response = client.post(
            "/nina/services/run",
            json={"service_name": "Echo", "object_hash": card_hash},
        )
    ...
    def test_run_service_not_found_object(self, client):
        ...
        response = client.post(
            "/nina/services/run",
            json={"service_name": "Echo", "object_hash": "nonexistent"},
        )
...
class TestQueryAPI:
    ...
    def test_execute_query(self, client):
        ...
        response = client.post("/nina/query", json={"text": "What is Newton?"})
...
class TestInspectorAPI:
    ...
    def test_inspect_card(self, client):
        ...
        # Create card
        create_resp = client.post(
            "/nina/cards", json={"title": "Inspect Me", "content": "Content here"}
        )
        card_id = create_resp.json()["data"]["id"]
...
class TestLinkAPI:
    ...
    def test_create_link(self, client):
        ...
        # Create two cards
        card1 = client.post(
            "/nina/cards", json={"title": "Source", "content": "From here"}
        ).json()["data"]

        card2 = client.post(
            "/nina/cards", json={"title": "Target", "content": "To here"}
        ).json()["data"]
    ...
    def test_list_links(self, client):
        ...
        card1 = client.post("/nina/cards", json={"title": "A", "content": "1"}).json()[
            "data"
        ]
        card2 = client.post("/nina/cards", json={"title": "B", "content": "2"}).json()[
            "data"
        ]

        client.post(
            "/nina/links",
            json={"source_hash": card1["hash"], "target_hash": card2["hash"]},
        )
    ...
    def test_list_links_filtered(self, client):
        ...
        card3 = client.post("/nina/cards", json={"title": "C", "content": "3"}).json()[
            "data"
        ]
        ...
        client.post(
            "/nina/links",
            json={"source_hash": card2["hash"], "target_hash": card3["hash"]},
        )
...
class TestTinyTalkAPI:
    ...
    def test_run_simple_code(self, client):
        ...
        response = client.post("/nina/tinytalk", json={"code": "2 + 3"})
    ...
    def test_run_invalid_code(self, client):
        ...
        response = client.post(
            "/nina/tinytalk", json={"code": "this is not valid code !!!"}
        )
