...
class TestKinematicSignature:
    ...
    def test_magnitude(self):
        ...
        sig = KinematicSignature(word="test", force_vector=(3.0, 4.0, 0.0))
...
class TestDistortionMetric:
    ...
    def test_different_metrics(self):
        ...
        d_euclidean = metric.compute_distortion(
            "walk", "cut_precise", metric="euclidean"
        )
        d_cosine = metric.compute_distortion("walk", "cut_precise", metric="cosine")
        d_manhattan = metric.compute_distortion(
            "walk", "cut_precise", metric="manhattan"
        )
...
class TestAdmissibilityCheck:
    ...
    def test_suggest_alternatives(self):
        ...
        suggestions = metric.suggest_alternatives(
            "enter_water_forceful", max_distortion=1.0
        )
...
class TestGeometryMismatchError:
    ...
    def test_verify_or_raise_pass(self):
        ...
        distortion = metric.verify_or_raise(
            "dive", "enter_water_forceful", threshold=2.0
        )
        assert distortion >= 0
