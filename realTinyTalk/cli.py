...
Examples:
  ...
  tinytalk repl                      Interactive mode
    ...
    run_parser.add_argument(
        "-q", "--quiet", action="store_true", help="Suppress result output"
    )
    ...
    build_parser.add_argument(
        "-t", "--target", default="js", choices=["js"], help="Target language"
    )
    build_parser.add_argument("-o", "--output", help="Output file")
    build_parser.add_argument(
        "--no-runtime", action="store_true", help="Omit runtime shim"
    )
    ...
    test_parser.add_argument(
        "--target", choices=["py", "js"], help="Test against target"
    )
