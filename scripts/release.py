...
RELEASE_NOTES = Path('RELEASE_NOTES.md').read_text(encoding='utf-8') if Path('RELEASE_NOTES.md').exists() else ''
...
body = {'tag_name': TAG, 'name': TAG, 'body': RELEASE_NOTES, 'draft': bool(IS_DRAFT), 'prerelease': bool(IS_PRERELEASE)}
